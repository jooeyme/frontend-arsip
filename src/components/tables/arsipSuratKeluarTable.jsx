...
import { getArchivedSuratKeluar, deleteSuratKeluar } from "../../modules/fetch/surat-keluar"
...
export default function ArsipSuratKeluarTable({
  me, 
  keyword = "",
  searchResults = [],
  loadingSearch 
  ...
  const fetchData = useCallback(async () => {
      try {
        ...
        const response = await getArchivedSuratKeluar( page, limit );
  ...
  return (
    ...
    <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <span className="ml-2">entri per halaman</span>
        </div>
      </div>
