...
export default function Document({data}) {
  ...
  console.log('apa isi document:', ID)
  const handleAmbilID = (data) => {
    const id_masuk = data.find(item => item.no_agenda_masuk !== null)?.no_agenda_masuk;
    console.log(id_masuk);

    const id_keluar = data.find(item => item.no_agenda_keluar !== null)?.no_agenda_keluar;
    ...
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          {data.map((document) => (
            <div key={document.id} className="lg:w-200 lg:h-120">
